...
namespace Perseverance_Calculator_1.Pages
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
            ...
            IVisual2D_Graph_Bindings
        {
            ...
            {
                if (lineNumber == 140 && columnNumber == 72)
                {
                    isobj7VisibilityDisabled = true;
                }
                else if (lineNumber == 141 && columnNumber == 50)
                {
                    isobj8TextDisabled = true;
                }
                else if (lineNumber == 142 && columnNumber == 51)
                {
                    isobj9SelectedIndexDisabled = true;
                }
                else if (lineNumber == 153 && columnNumber == 99)
                {
                    isobj10TextDisabled = true;
                }
                else if (lineNumber == 132 && columnNumber == 104)
                {
                    isobj11ContentDisabled = true;
                }
                else if (lineNumber == 132 && columnNumber == 211)
                {
                    isobj11TagDisabled = true;
                }
                else if (lineNumber == 133 && columnNumber == 180)
                {
            ...
            IVisual2D_Graph_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 90 && columnNumber == 46)
                {
                ...
                else if (lineNumber == 79 && columnNumber == 46)
                {
                    isobj21TextDisabled = true;
                }
                else if (lineNumber == 80 && columnNumber == 46)
                {
