...
namespace Perseverance_Calculator_1.Pages
{
    ...
    /// </summary>
    public sealed partial class Visual2D_Graph : Page
    {
        ...
        public Visual2D_Graph()
        {
            this.InitializeComponent();
            //view = ApplicationView.GetForCurrentView();
            //view.Consolidated += View_Consolidated;
            ViewPages.Visual2DGraphView.Closed += Current_Closed;
            //ApplicationView.GetForCurrentView().Title = "2D Graph";
        }
        ...
        //        await ViewPages.Visual2DGraphView.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
        //        {
        //            ViewPages.Visual2DGraphView.CoreWindow.Close();
        //        });
        //}
        private void Current_Closed(object sender, WindowEventArgs e)
        {
            ...
            this.timer.Stop();
            this.timer.Tick -= timer_Tick;
            ViewPages.Visual2DGraphView = null;
        }
        ...
        private void timer_Tick(object sender, object e)
        {
            ...
            if (currentProject != FormulaCollection_MVVM_Selection.selectedProjectIndex)
            {
                ...
                {
                    if (FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties.Count <= 0)
                    {
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties.Add(new Graph2DFormulaList_Properties());
                    }
                    ...
                    bindFormulaCollection.UpdateSourceTrigger = UpdateSourceTrigger.PropertyChanged;
                    bindFormulaCollection.Source = FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList;
                    ...
                    bindProp.Source = FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties;
            ...
            if (isPlaying)
            {
                try
                {
                    double graphTime = (!string.IsNullOrWhiteSpace(FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphTimeOnPlay))
                        ? double.Parse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphTimeOnPlay, false), System.Globalization.NumberStyles.Any) : 65;
            ...
            else
            {
                try
                {
                    double graphTime = (!string.IsNullOrWhiteSpace(FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphTime))
                        ? double.Parse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphTime, false), System.Globalization.NumberStyles.Any) : 200;
            ...
            if (FormulaCollection_MVVM_Selection.selectedProjectIndex >= 0)
            {
                if (FormulaProject_MVVM.formulaProject.Count >= FormulaCollection_MVVM_Selection.selectedProjectIndex)
                    if (FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties.Count > 0)
                    {
                        ...
                        //try
                        //{
                        double graphStepX = (FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepX.Equals("") ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepX.Equals("-") ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepX.Equals(double.PositiveInfinity.ToString()) ||
                        !double.TryParse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepX, false), System.Globalization.NumberStyles.Any, CultureInfo.CurrentCulture, out graphStepX) ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepX.Equals(".")) ?
                            1d : graphStepX;


                        double graphStepY = (FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepY.Equals("") ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepY.Equals("-") ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepY.Equals(double.PositiveInfinity.ToString()) ||
                        !double.TryParse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepY, false), System.Globalization.NumberStyles.Any, CultureInfo.CurrentCulture, out graphStepY) ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepY.Equals(".")) ?
                            1d : graphStepY;


                        double graphScale = (FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphScale.Equals("") ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphScale.Equals("-") ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphScale.Equals(double.PositiveInfinity.ToString()) ||
                        !double.TryParse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphScale, false), System.Globalization.NumberStyles.Any, CultureInfo.CurrentCulture, out graphScale) ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphScale.Equals(".")) ?
                            1d : graphScale;


                        double graphResolution = (FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphResolution.Equals("") ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphResolution.Equals("-") ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphResolution.Equals(double.PositiveInfinity.ToString()) ||
                        !double.TryParse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphResolution, false), System.Globalization.NumberStyles.Any, CultureInfo.CurrentCulture, out graphResolution) ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphResolution.Equals(".")) ?
                            .01d : graphResolution;

                        double graphLocationX = (FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationX.Equals("") ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationX.Equals("-") ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationX.Equals(double.PositiveInfinity.ToString()) ||
                        !double.TryParse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationX, false), System.Globalization.NumberStyles.Any, CultureInfo.CurrentCulture, out graphLocationX) ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationX.Equals(".")) ?
                            0d : graphLocationX;

                        double graphLocationY = (FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationY.Equals("") ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationY.Equals("-") ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationY.Equals(double.PositiveInfinity.ToString()) ||
                        !double.TryParse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationY, false), System.Globalization.NumberStyles.Any, CultureInfo.CurrentCulture, out graphLocationY) ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationY.Equals(".")) ?
                            0d : graphLocationY;

                        double axisSpacing = (FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].axisSpacing.Equals("") ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].axisSpacing.Equals("-") ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].axisSpacing.Equals(double.PositiveInfinity.ToString()) ||
                        !double.TryParse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].axisSpacing, false), System.Globalization.NumberStyles.Any, CultureInfo.CurrentCulture, out axisSpacing) ||
                        FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].axisSpacing.Equals(".")) ?
                            //100d : double.Parse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].axisSpacing, false), System.Globalization.NumberStyles.Any);
                            100d : axisSpacing;
                        ...
                        foreach (Graph2DFormulaList graphFormula in FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList)
                        {
                            foreach (Formula formula in FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].formulaCollection)
                            {
                                if (!string.IsNullOrWhiteSpace(graphFormula.formulaName) && !string.IsNullOrWhiteSpace(formula.formulaName))
                                    if (graphFormula.formulaName.Equals(formula.formulaName, StringComparison.CurrentCulture))
                                    {
                                        ...
                                        //if ()
                                        //{
                                        double circleRadius = (graphFormula.circleRadius.Equals("") ||
                                       graphFormula.circleRadius.Equals("-") ||
                                       graphFormula.circleRadius.Equals(double.PositiveInfinity.ToString()) ||
                                       !double.TryParse(new MathVue<double>().solveFormula(null, graphFormula.circleRadius, false), System.Globalization.NumberStyles.Any, CultureInfo.CurrentCulture, out circleRadius) ||
                                        graphFormula.circleRadius.Equals(".")) ?
                                            //1f : cRadius;
                                            //1f : double.Parse(new MathVue<double>().solveFormula(null, graphFormula.circleRadius, false), System.Globalization.NumberStyles.Any);
                                            1f : circleRadius;
                                        //}
                                        StringVue strV = new StringVue();
                                        string data = strV.replaceData(formula.rearrangedFormula, "time", elapsedTimeMS.ToString()).getNewData;
                                        data = strV.replaceData(data, "circleRadius", graphFormula.circleRadius.ToString()).getNewData.Replace("\n", "").Replace("\r", "").Replace(" ", "");

                                        new Controller.Graphing.Graph2D.Graph2D().render2DDataX(sender, args, formula, data, x, y, graphStepX, graphStepY, graphScale, graphResolution, graphLocationX, graphLocationY, lineColor, axisRange, axisSpacing, circleRadius);
                                        //}
                                        //catch { }
        ...
        {
            if (FormulaCollection_MVVM_Selection.selectedProjectIndex != -1)
                FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList.Add(new Model.Graph2DFormulaList());
        }

        private void Button_FormulaName_Click(object sender, RoutedEventArgs e)
        {

            Graph2DFormulaList graphFormulaSelection = (Graph2DFormulaList)((Button)sender).Tag;
        ...
        private void Button_FormulaNameDelete_Click(object sender, RoutedEventArgs e)
        {
            ...
            Graph2DFormulaList graphFormulaSelection = (Graph2DFormulaList)((Button)sender).Tag;
            int index = FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList.IndexOf(graphFormulaSelection);

            FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList.RemoveAt(index);
        }
        ...
        private async void Win2D_Canvas_PointerPressed(object sender, PointerRoutedEventArgs e)
        {
            ...
            if (FormulaCollection_MVVM_Selection.selectedProjectIndex != -1)
            {
                currentX = FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationX;
                currentY = FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationY;
            }
                    ...
                    Win2D_Canvas.DispatcherQueue.TryEnqueue(Microsoft.UI.Dispatching.DispatcherQueuePriority.Normal, () =>
                    {
                        try
                        {
                            if (FormulaCollection_MVVM_Selection.selectedProjectIndex != -1)
                            {
                                ...
                                FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationX =
                                ...
                                FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationY =
        ...
        private void Win2D_Canvas_PointerWheelChanged(object sender, PointerRoutedEventArgs e)
        {
            ...
            if (FormulaCollection_MVVM_Selection.selectedProjectIndex != -1)
            {
                ...
                try
                {
                    ...
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphScale.Equals("-") ||
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphScale.Equals(".")) ?
                        1d : double.Parse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphScale, false), System.Globalization.NumberStyles.Any);
                    ...
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphScale = graphScale.ToString();
                }
                catch { }
        ...
        private void TextBox_AxisSpacing_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (FormulaCollection_MVVM_Selection.selectedProjectIndex != -1)
            {
                ...
                try
                {
                    ...
                    currentX = FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationX;
                    currentY = FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationY;
                    //_axisSpacing = FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].axisSpacing;
        ...
        private void TextBox_GraphStepX_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (FormulaCollection_MVVM_Selection.selectedProjectIndex != -1)
            {
                ...
                try
                {
                    ...
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepY.Equals("-") ||
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepY.Equals(".")) ?
                        1d : double.Parse(new MathVue<double>().solveFormula(null, new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepY, false), false), System.Globalization.NumberStyles.Any);
                    ...
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationY =
                    (double.Parse(new MathVue<double>().solveFormula(null, currentY, false), System.Globalization.NumberStyles.Any) / double.Parse(new MathVue<double>().solveFormula(null, graphStepX, false), System.Globalization.NumberStyles.Any)).ToString();
        ...
        private void TextBox_GraphStepY_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (FormulaCollection_MVVM_Selection.selectedProjectIndex != -1)
            {
                ...
                try
                {
                    ...
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepX.Equals("-") ||
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepX.Equals(".")) ?
                        1d : double.Parse(new MathVue<double>().solveFormula(null, new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepX, false), false), System.Globalization.NumberStyles.Any);
                    ...
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationX =
                    (double.Parse(new MathVue<double>().solveFormula(null, currentX, false), System.Globalization.NumberStyles.Any) / double.Parse(new MathVue<double>().solveFormula(null, graphStepY, false), System.Globalization.NumberStyles.Any)).ToString();
        ...
        private void TextBox_PointX_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (FormulaCollection_MVVM_Selection.selectedProjectIndex != -1)
            {
                ...
                {
                    TextBox tbox = (TextBox)sender;
                    //double pointX = double.Parse(new MathVue<double>().solveFormula (null,tbox.Text,false), System.Globalization.NumberStyles.Any);
                    ...
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepX.Equals("-") ||
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepX.Equals(".")) ?
                        1d : double.Parse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepX, false), System.Globalization.NumberStyles.Any);

                    double graphStepY = (FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepY.Equals("") ||
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepY.Equals("-") ||
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepY.Equals(".")) ?
                        1d : double.Parse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphStepY, false), System.Globalization.NumberStyles.Any);
                    ...
                    //FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationX.Equals("-") ||
                    //FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationX.Equals(".")) ?
                    //    0d : double.Parse(new MathVue<double>().solveFormula (null,FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationX,false), System.Globalization.NumberStyles.Any);

                    //double graphLocationY = (FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationY.Equals("") ||
                    //FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationY.Equals("-") ||
                    //FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationY.Equals(".")) ?
                    //    0d : double.Parse(new MathVue<double>().solveFormula (null,FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationY,false), System.Globalization.NumberStyles.Any);
                    ...
                    double graphPointY = (FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphPointY.Equals("") ||
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphPointY.Equals("-") ||
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphPointY.Equals(".")) ?
                        0d : double.Parse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphPointY, false), System.Globalization.NumberStyles.Any);
                    ...
                    //FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphPointY = tbox.Text;

                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationX = newLocationX.ToString();
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphLocationY = newLocationY.ToString();
                }
                catch
                {
        ...
        private void TextBox_PointY_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (FormulaCollection_MVVM_Selection.selectedProjectIndex != -1)
            {
                ...
                {
                    TextBox tbox = (TextBox)sender;
                    //double pointY = double.Parse(new MathVue<double>().solveFormula (null,tbox.Text,false), System.Globalization.NumberStyles.Any);
                    ...
                    double graphPointX = (FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphPointX.Equals("") ||
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphPointX.Equals("-") ||
                    FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphPointX.Equals(".")) ?
                        0d : double.Parse(new MathVue<double>().solveFormula(null, FormulaProject_MVVM.formulaProject[FormulaCollection_MVVM_Selection.selectedProjectIndex].graph2DFormulaList_Properties[0].graphPointX, false), System.Globalization.NumberStyles.Any);
